...
A_{i-1,1} & A_{i-1,j+1}
\end{bmatrix})$.
If all entries in the first column are positive after population, then all roots are in the LHP. Otherwise, the number of RHP roots is equal to the number of sign changes in the column.
